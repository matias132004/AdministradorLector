    ...
    <div class="row justify-content-center">
        ...
        <div class="card card-danger">
                <div class="card-header">
                    <h3 class="card-title">Listado de ventas por Volumen</h3>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-end py-1 m-3">
                        <a href="<?php echo base_url() ?>ControladorPrecioVolumen/AgregarPrecioVolumen" class="btn btn-outline-success">
                            Agregar Venta por Volumen
                    ...
                    <?php if (!empty($datos)) : ?>
                        <div class="table-responsive">
                            <table id="idTabla" class="table table-bordered-lg">
                                <thead>
                                    <tr>
                                        <th scope="col">Id Venta por Volumen</th>
                                        <th scope="col">Id Producto</th>
                                        <th scope="col">Nombre Producto</th>
                                        <th scope="col">desde</th>
                                        <th scope="col">hasta</th>
                                        <th scope="col">Precio x volumen</th>
                                ...
                                <tbody>
                                    <?php foreach ($datos as $dato) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>ControladorPrecioVolumen/cargarEditarPrecioVolumen/<?php echo $dato['id_precio_volumen'] ?>"><button class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                                            <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001m-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708z" />
                                                        </svg></button></a>
                                            </td>
                                            <td>
                                                <button class="btn btn-outline-danger btn-eliminar" data-id="<?= $dato['id_precio_volumen'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                                        <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z" />
                                                        <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z" />
                                                    </svg></button>
                                            </td>
...
<div class="modal fade" id="confirmDeleteModal" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="eliminarConfirmarForm" action="<?php echo base_url() ?>ControladorPrecioVolumen/deleteTodo" method="post">
                <div class="modal-body">
...
<script>
    $(document).ready(function() {
        ...
        $("#eliminarPermanentemente").click(function() {
            ...
            window.location.href = "<?php echo base_url() ?>ControladorPrecioVolumen/eliminarPrecioVolumen/" + idEliminar;
        });
        ...
        $("#desactivar").click(function() {
            var idEliminar = $(this).data('id-eliminar');
            window.location.href = "<?php echo base_url() ?>ControladorPrecioVolumen/deshabilitarPrecioVolumen/" + idEliminar;
        });
