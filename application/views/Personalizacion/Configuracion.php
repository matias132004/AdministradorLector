                ...
                <div class="card-body">
                    <form method="post" action="<?php echo base_url() ?>ControladorConfiguracion/ModificarConfiguracion" method="POST">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label for="tiempoespera">Tiempo en pantalla del precio:</label>
                                <input type="number" id="tiempoespera" name="tiempoespera" class="form-control" value="<?php echo (int)($configuraciones['tiempoespera'] / 1000); ?>" required />
                            </div>
                        </div>
                </div>
                <div class="col-6">
