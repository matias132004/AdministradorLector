                                    ...
                                    <tbody>
                                        <?php foreach ($Datos as $dato) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url() ?>ControladorUsuarios/eliminarUsuario/<?php echo $dato['id_usuario'] ?>"><button class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
