<style>
    .logout-container {
        border-radius: 10px;
        /* Ajusta el valor según el radio deseado */
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a class="d-block" href="<?php echo base_url() ?>ControladorUsuarios/CargarCambiarContrasena"><?php echo $this->session->userdata('rut'); ?></a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>/ControladorMenu/Index" class="nav-link">
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-phone-fill" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>ControladorProducto/MostrarProducto" class="nav-link">
                                <i class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-check-fill" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>ControladorUmedida/MostrarUmedida" class="nav-link">
                                <i class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>ControladorFamilia/MostrarFamilia" class="nav-link">
                                <i class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-collection-fill" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>ControladorPrecioVolumen/MostrarPrecioVolumen" class="nav-link">
                                ...
                                <p>Venta por Volumen</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>ControladorEstadisticas/index" class="nav-link">
